...
$recipient = "ahodson@progresstesting.com, jsmith@progresstesting.com, showard@progresstesting.com, laura_bresko@yahoo.com, pjones@progresstesting.com, mateo@progresstesting.com, ";
...
$school_name = Trim(stripslashes($_POST['schoolName']));
$city = Trim(stripslashes($_POST['city']));
$phone = Trim(stripslashes($_POST['phone']));
$comments = Trim(stripslashes($_POST['Comments']));
$Planning_FH = Trim(stripslashes($_POST['Planning_FH']));
$Planning_FM = Trim(stripslashes($_POST['Planning_FM']));
$Planning_TH = Trim(stripslashes($_POST['Planning_TH']));
$Planning_TM = Trim(stripslashes($_POST['Planning_TM']));
$email = Trim(stripslashes($_POST['email']));
$principal = Trim(stripslashes($_POST['principal']));
$colleague = Trim(stripslashes($_POST['colleague']));
...
$fileatt = "sampleTests/" . Trim(stripslashes($_POST['file']));
$fileatt_type = "application/pdf";
$fileatt_name = Trim(stripslashes($_POST['file']));
...
$Body1 .= $colleague;
$Body1 .= "\n";
$Body1 .= "Planning Period: ";
$Body1 .= $Planning_FH . ":" . $Planning_FM . " To " . $Planning_TH . ":" . $Planning_TM;
$Body1 .= "\n";
$Body1 .= "Comments: ";
$Body1 .= $comments;
$Body1 .= "\n";
...
$success3 = mail($principal, $subject, $Body3, $headers);

// send email to colleague
$success4 = mail($colleague, $subject, $Body4, $headers);
